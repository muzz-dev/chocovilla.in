    ...
    <footer className="bg-primary-brown text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand Section */}
          <div>
            <h3 className="text-2xl font-bold text-gradient mb-4">ChocoVilla</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products" className="text-gray-300 hover:text-primary-gold transition-colors">
                  Products
                </Link>
              </li>
              <li>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-primary-gold">Contact Us</h4>
            <ul className="space-y-2 text-gray-300">
              <li>Founder: Aaishama Muzammil Nagariya</li>
              <li>Phone: +91 98259 47680</li>
              <li>Email: info.chocovilla@gmail.com</li>
              <li>
                <a
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center hover:text-primary-gold transition-colors group"
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} ChocoVilla. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
